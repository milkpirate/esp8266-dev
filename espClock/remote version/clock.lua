...
function conv_time_int(time) -- takes 4 digit time str
    ...
    dh = dig1[tonumber(time:sub(1,1))]
    oh = dig24[tonumber(time:sub(2,2))]
    dm = dig3[tonumber(time:sub(4,4))]
    om = dig24[tonumber(time:sub(5,5))]

    shift_int = bit.band(shift_int, bit_sec)
